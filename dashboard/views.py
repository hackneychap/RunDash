...
def dashboard(request):
    ...
    # Avoids recalculating 3 separate heavy DB group-by queries on every load.
    # The cache is automatically invalidated when a background sync finishes.
    ...
    if not context:
        ...
        # Cache for 24 hours, will be invalidated early by sync
