...
def dashboard(request):
    # ⚡ Bolt Optimization: Cache expensive database aggregations
    # Improves page load speed by avoiding repeated DB aggregation queries
    ...
    if not context:
        ...
        cache.set('dashboard_context', context, timeout=60*60*24)  # Cache for 24 hours
