...
def dashboard(request):
    # ⚡ Bolt Optimization: Cache the expensive database aggregations
    # Improves page load speed significantly by bypassing DB processing on subsequent loads
    ...
    if not context:
        ...
        cache.set('dashboard_context', context, timeout=86400) # cache for 24 hours
