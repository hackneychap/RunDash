...
def dashboard(request):
    ...
    # Dynamic timeout until midnight ensures "this week vs last week" data
    # doesn't become stale the next day
    ...
    # Calculate seconds until local midnight to avoid serving stale data tomorrow
